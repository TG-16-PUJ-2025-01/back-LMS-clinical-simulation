  ...
  @Autowired
	...
	private void insertRoomsAndTypes() {
		...
		List<Room> rooms = Arrays.asList(
				...
				Room.builder().name("Sala2").type(roomTypes.get(1)).capacity(11).build(),
				Room.builder().name("Sala3").type(roomTypes.get(2)).capacity(11).build(),
				Room.builder().name("Sala4").type(roomTypes.get(3)).capacity(11).build(),
				Room.builder().name("Sala5").type(roomTypes.get(3)).capacity(11).build(),
				Room.builder().name("Sala6").type(roomTypes.get(3)).capacity(11).build(),
				Room.builder().name("Sala7").type(roomTypes.get(4)).capacity(11).build(),
				...
				Room.builder().name("Sala12").type(roomTypes.get(5)).capacity(11).build(),
				...
				Room.builder().name("Sala15").type(roomTypes.get(6)).capacity(11).build(),
				Room.builder().name("Sala16").type(roomTypes.get(7)).capacity(11).build(),
				Room.builder().name("Sala17").type(roomTypes.get(8)).capacity(11).build(),
				Room.builder().name("Sala18").type(roomTypes.get(9)).capacity(11).build(),
				Room.builder().name("Sala19").type(roomTypes.get(10)).capacity(11).build(),
