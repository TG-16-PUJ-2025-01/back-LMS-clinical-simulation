...
public class RubricTemplateController {
        ...
        public ResponseEntity<?> getAll(
                ...
                PaginationMetadataDto metadata = new PaginationMetadataDto(page,
                                rubricsTemplatesPage.getNumberOfElements(),
        ...
        public ResponseEntity<?> getRubricTemplateById(@PathVariable Long id) {
                ...
                if (rubricTemplate == null) {
                        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                                        .body(new ApiResponseDto<>(HttpStatus.NOT_FOUND.value(),
                                                        "No rubric template found", null, null));
                }

                return ResponseEntity.ok(
                                new ApiResponseDto<RubricTemplate>(HttpStatus.OK.value(), "ok", rubricTemplate, null));
        }
        ...
        public ResponseEntity<?> addRubricTemplate(@Valid @RequestBody RubricTemplateDTO rubricTemplate,
                ...
                return ResponseEntity.status(HttpStatus.CREATED)
                                .body(new ApiResponseDto<RubricTemplate>(HttpStatus.OK.value(),
        ...
        @Valid
        @PutMapping("/{id}")
        public ResponseEntity<?> updateRubricTemplate(@RequestBody RubricTemplateDTO rubricTemplate,
                ...
                try {
                        ...
                        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
                                        new ApiResponseDto<ErrorDto>(HttpStatus.BAD_REQUEST.value(),
                                                        "Unable to delete rubric template as other courses or practices are using it",
                                                        null, null));
        ...
        public ResponseEntity<?> getRubricCourses(@PathVariable Long id) {
                ...
                return ResponseEntity.ok(new ApiResponseDto<List<Course>>(HttpStatus.OK.value(), "ok",
                                rubricTemplate.getCourses(),
                                null));
        }
