...
public interface RubricTemplateRepository extends JpaRepository<RubricTemplate, Long> {
    ...
    """)
    Page<RubricTemplate> findNotArchivedByTitleOrCreationDateContaining(@Param("filter") String filter, Pageable pageable);
    ...
    @Query("""
        ...
        WHERE 
            ...
            AND c.archived = true
    """)
    Page<RubricTemplate> findArchivedByTitleOrCreationDateContaining(@Param("filter") String filter, Pageable pageable);
